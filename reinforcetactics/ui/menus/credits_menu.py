...
class CreditsMenu(Menu):
    ...
    def _draw_content(self) -> None:
        ...
        title_rect = title_surface.get_rect(centerx=self.screen.get_width() // 2, y=120)
        ...
        developer_label_rect = developer_label_surface.get_rect(centerx=self.screen.get_width() // 2, y=200)
        ...
        developer_name_rect = developer_name_surface.get_rect(centerx=self.screen.get_width() // 2, y=230)
        ...
        description_rect = description_surface.get_rect(centerx=self.screen.get_width() // 2, y=280)
