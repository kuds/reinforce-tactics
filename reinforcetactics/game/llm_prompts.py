...
3. Cleric (C): Cost 200 gold, HP 10, Attack 2, Defense 4, Movement 3
...
- Cleric (C): Support unit, can HEAL/CURE allies (range 1-3), 10 HP, 3 movement
...
UNIT_DESCRIPTIONS = {
   ...
   - Can attack at range (1-2 spaces)
   - Can PARALYZE enemies (disable them for 3 turns, 2-turn cooldown)""",
    "C": """Cleric (C): Cost 200 gold, HP 10, Attack 2, Defense 4, Movement 3
   - Can HEAL allies (range 1-3) and CURE paralyzed units (range 1-3)""",
...
UNIT_DESCRIPTIONS_SHORT = {
    ...
    "C": "Cleric (C): Support unit, can HEAL/CURE allies (range 1-3), 10 HP, 3 movement",
