...
def get_player_name(bot, bot_type, model_path=None):
    ...
    """
    # For basic bots (SimpleBot, MediumBot, AdvancedBot, StrategySwitchingBot), use the class name
    if bot_type in ("SimpleBot", "MediumBot", "AdvancedBot", "StrategySwitchingBot"):
        return bot_type
...
def create_bot(game, player_num, bot_type, settings, model_path=None):
    ...
    if bot_type == "StrategySwitchingBot":
        return StrategySwitchingBot(game, player=player_num)
