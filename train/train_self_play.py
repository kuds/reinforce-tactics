...
def train_self_play(args) -> Path:
    ...
    checkpoint_callback = CheckpointCallback(
        save_freq=args.checkpoint_freq, save_path=str(checkpoint_dir), name_prefix="self_play"
    )
...
def train_mixed(args) -> Path:
    ...
    # Checkpoint callback
    checkpoint_callback = CheckpointCallback(
        save_freq=args.checkpoint_freq, save_path=str(checkpoint_dir), name_prefix="mixed"
    )
    callbacks.append(checkpoint_callback)
